			...
			<form className='add-product-form' onSubmit={handleSubmit}>
				...
				<div className='form-group'>
					...
					>
						...
						<option value='artificial'>Man Shirt</option>
						<option value='real-plants'>Man denims</option>
						<option value='pots'>Women Skirt</option>
						<option value='accessories'>frocks</option>
						<option value='cosmetics'>women Denims</option>
					</select>
				</div>
